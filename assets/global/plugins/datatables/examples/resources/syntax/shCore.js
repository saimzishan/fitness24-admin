...
/**
 * Finds an new of element in the array.
 * @ignore
 * @param {Object} searchElement
 * @param {Number} fromIndex
 * @return {Number} Returns new of element if found; -1 otherwise.
 */
 ...
 * new position and then by length.
 *
...
function matchesSortCallback(m1, m2)
{
    ...
    {
        // if new is the same, sort by length
...
;(function()
{
    ...
    function Brush()
    {
        ...
        var keywords =  'ascent azimuth background-attachment background-color background-image background-position ' +
                        ...
                        'vertical-align visibility voice-family volume white-space widows width widths word-spacing x-height z-new';
...
;(function()
{
    ...
    function Brush()
    {
        ...
        var keywords =  'absolute action add after alter as asc at authorization begin bigint ' +
                        ...
                        'group grouping having hour ignore new inner insensitive insert instead ' +
