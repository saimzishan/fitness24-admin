    ...
    return {
        ...
        initPieCharts: function () {
                        ...
                        pie: {
                            ...
                            label: {
                                ...
                                formatter: function (label, series) {
                                    return '<div style="fonts-size:8pt;text-align:center;padding:2px;color:white;">' + label + '<br/>' + Math.round(series.percent) + '%</div>';
                                },
                                background: {
                                    opacity: 0.8
                                }
            ...
            if (!obj)
                ...
                $("#hover").html('<span style="fonts-weight: bold; color: ' + obj.series.color + '">' + obj.series.label + ' (' + percent + '%)</span>');
            }
