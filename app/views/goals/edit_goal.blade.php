            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-cascade">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-users"></i> Edit Goal
                        </div>
                    </div>
                    <div class="portlet-body form">
                         
                        {{Form::open(array('route' => 'update_goal', 'name'=>'update_goal', 'enctype'=>'multipart/form-data', 'onsubmit'=>'return validateForm()'))}}
                        <div class="form-body">
                            <?php
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="width: 80%">
                                            ...
                                            <input type="text" class="form-control" name="title_en" value="<?php echo $goal->title_en; ?>" required>                                          
                                        </div>
                                    </div>   
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="width: 80%">
                                             <input type="text" class="form-control" name="title_ar" value="<?php echo $goal->title_ar; ?>" required>
                                        </div>
                                    </div>
                            ...
                            <div class="margiv-top-10">
                                <input type="submit" class="btn green" value="Save Goals">
