            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-cascade">
                    ...
                    <div class="portlet-body form">
                        {{Form::open(array('route' => 'post_signup', 'name'=>'user-registration', 'enctype'=>'multipart/form-data', 'onsubmit'=>'return validateForm()'))}}
                        <div class="form-body">
                            <?php
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6 ">
                                    ...
                                    <div class="form-group">
                                        <label>Email</label>
                                        <div class="input-group" style="width: 80%">
                                            {{ Form::email('email',Input::old("email"),array('id'=>'email','class'=>'form-control','placeholder'=>'Email Address','required')) }}
                                        </div>
                                    </div>
