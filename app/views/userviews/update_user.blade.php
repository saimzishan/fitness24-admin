                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>Gender</label>
                                        <div class="input-group" style="width: 80%">
                                            {{ Form::select('gender',array('Male'=>'Male', 'Female'=>'Female'),Input::old("gender"),array('class'=>'form-control','placeholder'=>'Email Address','required')) }}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Current Height</label>
                                        <div class="input-group" style="width: 80%">
                                            {{ Form::number('current_date_height',Input::old("current_date_height"),array('class'=>'form-control','placeholder'=>'Current Date height','required')) }}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Current Weight</label>
                                        <div class="input-group" style="width: 80%">
                                            {{ Form::number('current_date_weight',Input::old("current_date_weight"),array('class'=>'form-control','placeholder'=>'Current Date Weight','required')) }}
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="width: 80%">
                                            {{ Form::number('current_bmi',Input::old("current_bmi"),array('class'=>'form-control','placeholder'=>'Current BMI','required')) }}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div data-provides="fileinput" class="fileinput fileinput-new" id="old_image">
                                        <div style="width: 180px; height: 170px; line-height: 150px;" data-trigger="fileinput" class="fileinput-preview thumbnail">
                                            <img style="width: 180px; height: 160px;" src="<?php echo CommonHelper::$driver['s3_uploads'] . 'users/'. $user->image; ?>" alt=""/>
                                        </div>
                                        <!--                                        <div>
