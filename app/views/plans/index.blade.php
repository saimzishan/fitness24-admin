                    ...
                    <div class="portlet box grey-cascade">
                        ...
                        <div class="portlet-body">
                            ...
                            <div id="success-mesg" class="alert alert-success alert-dismissible">
                                <strong>Succes:</strong> Plan Days Updated Successfully.
                              </div>
                                         ...
                                         <div class="container-fluid" style=" ">
                                             ...
                                             @foreach($codes->plandays as $planDay)
                                                <div class="row" style="padding: 10px; background-color: #90A4AE">
                                                   ...
                                                   <div class="col-md-2">
                                                                            <a  href="<?php echo route("getAllExercse", array('id' => $planDay['id'])); ?>" title="Add viedo">
                                                  ...
                                                  <!-- Plan days Exercises -->
                                                    <div class="container-fluid" style="">
                                                         <div id="plandaysExerColaps{{$planDay['id']}}" class="collapse">
                                                            ...
                                                            <!-- header -->
                                                            <!-- body -->
                                                                 @foreach($planDay->dayExercise as $planDayExer)
                                                                 <div class="row" style="padding: 1%; background-color: #B0BEC5">
                                                                          ...
                                                                          <div class="col-md-2">
                                                                            <a  onclick="return confirm('Are you sure you want to delete this exercise?');" href="<?php echo route("deleteExerciseOfDay", array('id' => $planDayExer['id'])); ?>" title="Delete">
                                                    <div style="font-size: 22px;color: black;" class="fa fa-trash-o"></div>
                                                </a>
                                                                          </div>
              ...
              <!-- ex_videos -->
               <div class="container-fluid" style="">
                    <div id="plandaysExerVideo{{$planDayExer['id']}}" class="collapse">
                     ...
                     <!-- header EEEEEE -->
                        <div class="row" style="padding: 10px; background-color: #EEEEEE; margin-top: -10px">
                          <div class="col-md-1">Id <?php echo count($planDayExer['exVideos']) ?></div>
                    ...
                    <!-- body -->
                        ...
                        @foreach($planDayExer->exVideos as $planDayExerVideo)
