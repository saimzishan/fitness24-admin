...
<div class="page-content-wrapper">
    <div class="page-content">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    Vehicles <small>Add new model</small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="javascript:;" style="text-decoration: none;">New vehicle type</a>
                    </li>
                </ul>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-cascade">
                    ...
                    <div class="portlet-body form">
                        {{Form::open(array('route' => 'post_make_model', 'name'=>'post_make_model', 'enctype'=>'multipart/form-data', 'onsubmit'=>'return validateForm()'))}}
                        <div class="form-body">
                            <?php
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6 ">
                                    ...
                                    <div class="form-group">
                                        <label>Model</label>
                                        <div class="input-group" style="width: 80%">
                                            {{ Form::text('model',Input::old("model"),array('id'=>'model','class'=>'form-control','placeholder'=>'example ...(Impreza WRX)', 'required')) }}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 ">
                                    <div  class="form-group">
                                        <label class="control-label">Select Model Image <span class="required">
                                                * </span>
                                        </label>
    ...
    <!--                                                <a onClick="browse_img()"></a> <span></span> <a href="#"></a>-->
                            ...
                            <div class="margiv-top-10">
                                <input type="submit" class="btn green" value="Save Type">
...
<script>
    function validateForm() {
        var x = document.forms["post_make_model"]["generation"].value;
        if (x == "select") {
