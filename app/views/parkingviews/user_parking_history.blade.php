                ...
                <div class="portlet box grey-cascade">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="tab-content">
                            <div id="parking_history_tab" class="tab-pane fade active in">
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($parking_history as $history) {
                                            ?>
                                            <tr  class="odd gradeX">
                                                <td>
                                                    <?php echo $history['id'] ?>
                                                ...
                                                <td>
                                                    <?php echo $history['parking_time'] ?>
                                                </td>
                                                <td>
                                                    <?php echo $history['checkout_time'] ?>
                                                </td>
                                                <td>
                                                    <?php echo $history['expiration_time'] ?>
                                                </td>
                                                <td>
                                                    $<?php echo $history['charge'] ?>
                                                </td>
                                                <td>
